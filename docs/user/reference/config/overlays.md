...
These overlays modify `.spec` files using the editor selected by [project.spec-editor](project.md#spec-editor). The default `legacy` editor is line-oriented; the `structural` editor preserves conditional and section structure.
